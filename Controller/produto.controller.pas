...
type
  ...
  public
    ...
    function VerificaProdutoUtilizado(QryTemp: TFDQuery; ACodigo: Integer): Boolean;
...
function TProdutoController.VerificaProdutoUtilizado(QryTemp: TFDQuery; ACodigo: Integer): Boolean;
begin
  Result := FProdutoRepo.VerificaProdutoUtilizado(QryTemp, ACodigo);
end;
